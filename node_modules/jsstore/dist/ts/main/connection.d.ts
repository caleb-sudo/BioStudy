...
import { ISelectQuery, ICountQuery, IInsertQuery, IUpdateQuery, IRemoveQuery, ITransactionQuery, IDataBase, EVENT, IPlugin, IIntersectQuery, IDbInfo, TMiddleware } from "../common";
...
export declare class Connection extends ConnectionHelper {
     ...
     * @memberof Connection
     */
    transaction<T>(query: ITransactionQuery): Promise<T>;
